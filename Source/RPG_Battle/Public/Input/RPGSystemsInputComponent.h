 ...
 */
UCLASS()
class RPG_BATTLE_API URPGSystemsInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
template<class UserClass, typename PressedFuncType, typename ReleasedFuncType>
inline void URPGSystemsInputComponent::BindAbilityActions(URPGInputConfig* InputConfig, UserClass* Object, 
