...
ARPG_BattleCharacter::ARPG_BattleCharacter()
{
...
void ARPG_BattleCharacter::PossessedBy(AController* NewController)
{
...
void ARPG_BattleCharacter::OnRep_PlayerState()
{
...
void ARPG_BattleCharacter::InitClassDefaults()
{
	...
	else if(UCharacterClassInfo* ClassInfo = URPGAbilitySystemLibrary::GetCharacterClassDefaultInfo(this))
	{
		if (FCharacterClassDefaultInfo* SelectedClassInfo = ClassInfo->ClassDefaultInfoMap.Find(CharacterTag))
		{
			if (IsValid(RPGAbilitySystemComp))
			{
				...
				RPGAbilitySystemComp->AddCharacterPassiveAbilities(SelectedClassInfo->StartingPassvies);
...
void ARPG_BattleCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ARPG_BattleCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARPG_BattleCharacter::Move);
...
void ARPG_BattleCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
